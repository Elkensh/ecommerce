                                  ...
                                  enctype = "multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            <div class="text-center">
                                                <img
                                                src="{{$vendors->logo}}"
                                                class="rounded-circle height-150" alt="صوره المتجر">

                                            </div>
                                        </div>


                                        <input name="id" value="{{$vendors->id}}" type="hidden"> {{-- for validation --}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" value="{{$vendors ->email}}" id="email"
                                                               class="form-control"
                                                               placeholder=""
                                                               name="email">
                                                               @error("email")
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$vendors ->address}}" id="address"
                                                            class="form-control"
                                                            placeholder=""
                                                            name="address">
                                                            @error("address")
...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&libraries=places&callback=initAutocomplete&language=ar&region=EG
         async defer"></script>
    @stop
    {{-- me == AIzaSyCbAgWEtebqeO_qPy82fxafhMhNsy715ls --}}
    {{--video == AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs --}}

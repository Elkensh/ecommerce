                                    ...
                                    <form class="form" action="{{route('admin.product.store')}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput2">  أختر القسم الفرعى </label>
                                                            <select name="sub_category_id" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر القسم الفرعى ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="" id="manage_stock"
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="manage_stock">
                                                                   @error("manage_stock")
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">متاح</label>

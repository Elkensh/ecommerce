  ...
  <div class="products-sort-order dropdown">
    ...
    <div class="dropdown-menu">
                        ...
                        @isset($products)
                            ...
                            <div class="item  col-lg-4 col-md-6 col-xs-12 text-center no-padding">
                                <div class="product-miniature js-product-miniature item-one" data-id-product="2" data-id-product-attribute="60" itemscope="" itemtype="http://schema.org/Product">
                                    ...
                                    <img class="img-fluid image-cover" src="{{$product->images[0]->filename ?? ''}}"
                                    alt=""
                                    data-full-size-image-url="{{$product->images[0]->filename ?? ''}}" width="600" height="600">
      ...
      <span>0 review</span>
          ...
          <div class="product-desc" itemprop="desciption">Vestibulum varius, massa sed luctus ornare, enim arcu sollicitudin velit, in ornare ex mauris eleifend nibh. Quisque id rhoncus diam,...</div>
        </div>
        <div class="product-buttons d-flex justify-content-center" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
          ...
          {{-- <form action="{{route('wishlist.delete',$product->id)}}" method="POST"> --}}
            <a class="addToWishlist" href="{{route('wishlist.delete',$product->id)}}"

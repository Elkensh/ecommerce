                            ...
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                <ul class="menu level1">
                                    ...
                                    <li class="item  parent" >
                                        <a href="{{route('category',$category->slug)}}" title="Laptops &amp; Accessories"><i class="hasicon nov-icon" style="background:url('http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/laptop.png') no-repeat scroll center center;">
                                </i>{{$category->name}}</a><span class="show-sub fa-active-sub"></span><span class="menu-sub-title">Dell. HP, Macbook, Alienware and etc...</span>
                                <div class="dropdown-menu" style="width:222px">
                                    <ul>

                                        @isset($SubCategory)
                                        @foreach ($SubCategory as $Sub_category)
                                       {{--  هنا بعت الاقسام الرئيسيه والفرعيه وقولت لما يساوو بعض يعرضهم  --}}
                                       @if(get_local_lang()=='ar')
                                        @if($Sub_category->mainCategory_id == $category->id)

                                    <li class="item " ><a href="{{route('category',$Sub_category->slug)}}" title="Trackpad">{{$Sub_category->name}}</a></li>

                                        @endif
                                        @endif

                                       @if(get_local_lang()!='ar')
                                        @if($Sub_category->mainCategory_id == $category->translation_of)
                        ...
                        <nav id="nov-megamenu" class="clearfix">
                            ...
                            <div id="megamenu" class="nov-megamenu clearfix">
                                <ul class="menu level1"><li class="item home-page has-sub" ><span class="opener"></span><a href="?home" title="Home"><i class="zmdi zmdi-home"></i>Home</a><div class="dropdown-menu" style="width:200px"><ul class=""><li class="item " ><a href="?home=home_1" title="Homepage 1">Homepage 1</a></li>
                                    ...
                                    <li class="item  group" ><span class="opener"></span><a href="http://demo.bestprestashoptheme.com/savemart/ar/2-������-��������" title="Categories"><i class="zmdi zmdi-group"></i>Categories</a><div class="dropdown-menu" ><ul class=""><li class="item container group" ><div class="dropdown-menu" ><ul class=""><li class="item col-lg-3 col-md-3 html" ><span class="menu-title">Laptop</span><div class="menu-content"><ul class="col">

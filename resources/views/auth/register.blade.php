...
<nav data-depth="1" class="breadcrumb-bg">
    ...
    <input type="hidden" name="id_customer" value="">
      ...
      <div class="col-md-6">
        ...
        <input id="password" type="password" class="form-control js-child-focus js-visible-password @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
      ...
      <div class="col-md-6">
          ...
          <div class="input-group js-parent-focus">
            <input id="password-confirm" type="password" class="form-control js-child-focus js-visible-password" name="password_confirmation" required autocomplete="new-password">
            <span class="input-group-btn">
              <button class="btn" type="button" data-action="show-password" data-text-show="Show" data-text-hide="Hide">
                Show
              </button>
